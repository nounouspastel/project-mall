...
public class Product {
	...
	public Product(String pseq, String name, String kind, int price_in, int price_out, String content, int quantity, String image, Date indate) {
		super();
		this.pseq = pseq;
		this.name = name;
		this.kind = kind;
