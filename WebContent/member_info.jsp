			...
			<div class="login_join">
				<div class="form_container">
					<section id="memberInfoArea">
						<form action="memberUpdateAction.me" method="post" name="form1">
							<div class="form-group">
								<p class="form_title_p">${id}정보</p>
							</div>
							<br>
							<div class="form_item_name">
								...
								<div class="form_item_name">
									<input type="text" class="form-control" name="id" id="id"
										value="${member.id}" placeholder="아이디입력하세요" readonly="readonly">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="form_item_name">
									<input type="email" class="form-control" name="email"
										id="email" value="${member.email}" placeholder="이메일입력하세요">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="form_item_name">
									<input type="text" id="sample6_address2"
										placeholder="상세주소입력하세요" name="address2" class="form-control"
							...
							<div class="form-group">
								...
								<div class="form_item_name">
									<input type="text" id="sample6_postcode"
										placeholder="우편번호입력하세요" name="zip_num" class="form-control"
							...
							<div class="form-group">
								<div>
									...
									<input type="button" value="회원탈퇴" class="btn btn-success"
										onclick="location.href='memberDeleteAction.me?id=${member.id}'">
									<input type="reset" value="돌아가기" class="btn btn-warning"
