		...
		<div id="frame">
			<form>
				...
				<br /> <br /> <span
					...
					상품 정보</span>
				<c:choose>
					<c:when test="${ordertodayview != null && ordertodayview.size() > 0 }">
						<table id="productInfo">
							...
							<tbody>
								<c:forEach var="orderview" items="${ordertodayview }" varStatus="status">
									<tr>
										<td>${orderview.odseq }</td>
										<td><img src="images/${orderview.image }" style="width: 100px;"></td>
										...
										<td><a href="#" style="background-color:#fff; color:blue; font-weight: bold;">주문취소</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
