        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                   ...
                   <div>
                   <form action="adminProductUpdate.ad" method="post" enctype="multipart/form-data"  name="form1">	 
                   	 <div class="table-responsive">
                   	 <table class="table">
	                   <tr>
					      <th><label for = "pseq">상품코드</label></th>
					      <td class = "td_right">
					         <input type = "text" name = "pseq" id ="pseq" value="${product.pseq}" readonly="readonly" /><small>(수정불가)</small>
					      </td>
					   </tr>    	 
           				<tr>
					      ...
					      <td class = "td_right">
					         <input type = "text" name = "name" id ="name" value="${product.name}" />
						      ...
						      <td class = "td_right"><input type = "text" name = "price_in" id ="price_in" value="${product.price_in}"/></td> 
						      <th><label for = "price_out">판매가</label></th>
						      <td class = "td_right"><input type = "text" name = "price_out" id ="price_out" value="${product.price_out}"/></td>
						   </tr>
           			    <tr>
           				 <th><label for = "content">상세설명</label></th>
           				 <td colspan="5"> 
	                      <textarea id="content" style="width:98%;height:200px;" name="content">${product.content}</textarea> 
           				 </td>
           				</tr>          				
           			 	<tr>
           				 <th><label for = "image">상품이미지</label></th>
           				 <td colspan="5"> 
	                       <input type="file" name="image" id="image" value="images/${product.image}"/>
           				 </td>
           				</tr>	
