...
<%
	...
	String chk_pseq = request.getParameter("pseqCheck");
...
//			out.println("</script>");
			response.sendRedirect("pseqCheck.jsp?chk_pseq="+chk_pseq+"&useble=no");
		}else{                          //아이디 사용 가능
//			out.println("<script>");
//			out.println("alert('아이디 사용이 가능합니다.')");	
//			out.println("</script>");
			response.sendRedirect("pseqCheck.jsp?chk_pseq="+chk_pseq+"&useble=yes");
		}
